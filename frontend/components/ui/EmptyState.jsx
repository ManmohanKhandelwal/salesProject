const EmptyState = ({
  title = "There’s no product here",
  message = "Try changing your filters to see appointments",
  onClear,
  onChange,
}) => {
  return (
    <div className="flex flex-col items-center justify-center p-6 rounded-lg shadow-md mt-6">
      <svg
        className="mx-auto"
